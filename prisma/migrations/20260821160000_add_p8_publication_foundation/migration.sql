...
CREATE TYPE "PublicationExecutionStatus" AS ENUM ('PENDING', 'READY', 'PLANNED', 'PREVIEW_READY', 'APPROVED', 'QUEUED', 'EXECUTING', 'PR_CREATED', 'DEPLOYED', 'VERIFYING', 'VERIFIED', 'APPROVAL_STALE', 'TARGET_REVISION_CHANGED', 'VERIFICATION_FAILED', 'STALE_REVIEW_REQUIRED', 'FAILED', 'ROLLBACK_PROPOSED', 'ROLLED_BACK');
CREATE TYPE "PublicationExecutionEventType" AS ENUM ('CREATED', 'READY', 'PLANNED', 'PREVIEW_READY', 'APPROVED', 'QUEUED', 'STARTED', 'PR_CREATED', 'DEPLOYED', 'VERIFICATION_STARTED', 'VERIFIED', 'APPROVAL_STALE', 'TARGET_REVISION_CHANGED', 'VERIFICATION_FAILED', 'STALE_REVIEW_REQUIRED', 'FAILED', 'ROLLBACK_PROPOSED', 'ROLLED_BACK');
