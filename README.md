...
P6-A is complete. It provides the Advanced/Enterprise foundation for externally sampled AI Visibility observations.
...
Operational details: `docs/development/p6a-visibility-sampling.md`.
